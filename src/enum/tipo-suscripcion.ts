export enum TipoSuscripcion {
    ...
    BRONZE = 'BRONZE', // Acceso a características estándar y descuentos limitados
    SILVER = 'SILVER', // Beneficios adicionales, como descuentos exclusivos y acceso anticipado a productos
